 ...
 */
 class Managesession {
    ...
    private int ses_id;
    private String lecturer,lecturer_2,subject_code,subject_name,group_id,tag,no_of_students,duration;

    public Managesession (int ses_id, String lecturer,String lecturer_2, String subject_code,String subject_name,String group_id,String tag, String no_of_students, String duration) {
